# Contributing to custom-mail-signatures

First and foremost, thank you! We appreciate that you want to contribute to custom-mail-signatures, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for custom-mail-signatures**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for custom-mail-signatures:

- star the [project](https://github.com/Pterobyte/custom-mail-signatures)
- tweet your support for custom-mail-signatures
...
- **version**: (required) please note the version of custom-mail-signatures are you using
...
The original poster or the maintainers of custom-mail-signatures may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/custom-mail-signatures
